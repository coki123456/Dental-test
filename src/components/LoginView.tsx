                        ...
                        <div className="flex-1">
                            ...
                            <div className="mt-8 space-y-6">
                                ...
                                <div className="space-y-4">
                                    <p className="text-sm text-gray-600 text-center">Para sincronizar tu calendario y gestionar tus turnos, inicia sesión con Google.</p>
                                    <button
                                        type="button"
                                        disabled={loading}
                                ...
                                <div className="pt-4">
                                    <p className="text-xs text-center text-gray-400">Al continuar, aceptas la sincronización automática de tu calendario de Google para la gestión de turnos.</p>
                                </div>
                            </div>
                        </div>
